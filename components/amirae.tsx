...
export default function AmiraeSection() {
  ...
  return (
    <section id="why-amirae" className="relative w-full py-28 px-6 md:px-16 bg-[#F4F1EA] text-[#1F1E1D] overflow-hidden font-[family-name:var(--font-your-hero-font)]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-6 border-b border-[#1F1E1D]/15"
        >
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 bg-[#1F1E1D] text-[#F4F1EA] p-8 md:p-12 flex flex-col justify-between rounded-sm shadow-xl relative overflow-hidden group"
          >
